    ...
    <div class="col-md-12">
      <time-line type="simple">
        <time-line-item
          inverted
          badge-type="danger"
          badge-icon="now-ui-icons business_briefcase-24">
          <span
            slot="header"
            class="badge badge-danger">Some title</span>
          <p slot="content">
        ...
        <time-line-item
          ...
          <span
            slot="header"
            class="badge badge-success">Another Title</span>
          <p slot="content">
        ...
        <time-line-item
          inverted
          badge-type="info"
          badge-icon="now-ui-icons gestures_tap-01">
          <span
            slot="header"
            class="badge badge-info">Another Title</span>
          <div slot="content">
            <p>
        ...
        <time-line-item
          ...
          <span
            slot="header"
            class="badge badge-warning">Another Title</span>
          <p slot="content">
