<template>
  <ul class="nav nav-mobile-menu">
    ...
    <drop-down>
      ...
      <a
        class="dropdown-item"
        href="#">Create New Post</a>
      <a
        class="dropdown-item"
        href="#">Manage Something</a>
      <a
        class="dropdown-item"
        href="#">Do Nothing</a>
      <a
        class="dropdown-item"
        href="#">Submit to Live</a>
      <a
        class="dropdown-item"
    ...
    <drop-down>
      ...
      <a
        class="dropdown-item"
        href="#">
        <i class="nc-icon nc-umbrella-13"/> Help Center
      </a>
      <a
        class="dropdown-item"
        href="#">
        <i class="nc-icon nc-email-85"/> Messages
      </a><a
        class="dropdown-item"
        href="#">
        <i class="nc-icon nc-settings-90"/> Settings
      </a>
      <div class="divider"/>
      <a
        class="dropdown-item"
        href="#">
        <i class="nc-icon nc-lock-circle-open"/> Lock Screen
      </a>
      <a
        href="#"
        class="dropdown-item text-danger">
        <i class="nc-icon nc-button-power"/> Log out
      </a>
    </drop-down>
  </ul>
</template>
